 ...
 * version: 1.0
 */
public class SubIncomeThirtyFragment extends BaseFragment {


    //筛选时间
    @BindView(R.id.tv_income_thirty_time)
    TextView mTime;
    //30天收入
    @BindView(R.id.tv_income_thirty_earning)
    TextView mEarning;
    //单日最高
    @BindView(R.id.tv_income_thirty_biggest)
    TextView mBiggest;
    //日均
    @BindView(R.id.tv_income_thirty_daily)
    TextView mDaily;
    //较之前30天
    @BindView(R.id.tv_income_thirty_before)
    TextView mCompare ;
    //自定义刷新
    ...
    public static Fragment newInstance() {
        SubIncomeThirtyFragment fragment = new SubIncomeThirtyFragment();
        return fragment;
    }
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_income_thirty;
    }
    ...
    public void incomeStatement() {
        ...
        try {
            ...
            jsonObject.put("endDay", "2019-05-12");
