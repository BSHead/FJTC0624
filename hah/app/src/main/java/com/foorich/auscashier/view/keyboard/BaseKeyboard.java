...
public class BaseKeyboard {
    ...
    private void randomKeyboardNumber() {
        List<android.inputmethodservice.Keyboard.Key> keyList = Keyboard.getKeys();
        // 查找出0-9的数字键
        List<android.inputmethodservice.Keyboard.Key> newkeyList = new ArrayList<android.inputmethodservice.Keyboard.Key>();
