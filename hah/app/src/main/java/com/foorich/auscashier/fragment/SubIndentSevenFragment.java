 ...
 * version: 1.0
 */
public class SubIndentSevenFragment extends BaseFragment {

    //筛选时间
    @BindView(R.id.tv_indent_seven_time)
    TextView mTime;
    //7天订单
    @BindView(R.id.tv_indent_seven_earning)
    TextView mEarning;
    //单日最高
    @BindView(R.id.tv_indent_seven_biggest)
    TextView mBiggest;
    //日均
    @BindView(R.id.tv_indent_seven_daily)
    TextView mDaily;
    //较之前7天
    @BindView(R.id.tv_indent_seven_before)
    TextView mCompare;
    //自定义刷新
    ...
    public static Fragment newInstance() {
        SubIndentSevenFragment fragment = new SubIndentSevenFragment();
        return fragment;
    }
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_indent_seven;
    }
    ...
    public void incomeStatement() {
        ...
        try {
            ...
            jsonObject.put("startDay", "2019-06-03");
            jsonObject.put("endDay", "2019-06-09");
            jsonObject.put("dateType", "7");
            ...
            map.put("startDay", "2019-06-03");
            map.put("endDay", "2019-06-09");
            map.put("dateType", "7");
        ...
        //请求接口
        HttpManager.getHttpManager().postMethod(ApiService.orderStatement, new Observer<String>() {
                    @Override
                    ...
                    public void onNext(String json) {
                        ...
                        if (commonalityBean.getRetCode().equals("SUCCESS")) {
                            ...
                            if (commonalityBean.getData().getRatio().contains("+")) {
                                ...
                                // commonalityBean.getData().getRatio().subSequence(0,1);
                                mCompare.setText( commonalityBean.getData().getRatio().substring(1));
