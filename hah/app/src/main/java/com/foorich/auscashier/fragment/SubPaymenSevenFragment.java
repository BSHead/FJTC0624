 ...
 * version: 1.0
 */
public class SubPaymenSevenFragment extends BaseFragment {

    //筛选时间
    @BindView(R.id.tv_payment_seven_time)
    TextView mTime;
    //报表
    @BindView(R.id.pv_payment_seven)
    PieView mPieView;
    //自定义刷新
    @BindView(R.id.refresh)
    TwinklingRefreshLayout refreshLayout;
    //支付方式
    @BindView(R.id.re_payment_seven)
    ...
    public static Fragment newInstance() {
        SubPaymenSevenFragment fragment = new SubPaymenSevenFragment();
        return fragment;
    }
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_payment_seven;
    }
    ...
    public void incomeStatement() {
        ...
        try {
            ...
            jsonObject.put("startDay", "2019-06-06");
                    ...
                    public void onNext(String json) {
                        ...
                        if (commonalityBean.getRetCode().equals("SUCCESS")) {
                            ...
                            for (int i = 0; i < payList.size(); i++) {
                                ...
                                item.setColor(Color.parseColor(payList.get(i).getColor()));//设置扇形背景颜色
                                item.setData(Integer.parseInt(payList.get(i).getCount()));//设置扇形面积显示
