 ...
 * version: 1.0
 */
public class SubIndentNinetyFragment extends BaseFragment {

    //筛选时间
    @BindView(R.id.tv_indent_ninety_time)
    TextView mTime;
    //90天订单
    @BindView(R.id.tv_indent_ninety_earning)
    TextView mEarning;
    //单日最高
    @BindView(R.id.tv_indent_ninety_biggest)
    TextView mBiggest;
    //日均
    @BindView(R.id.tv_indent_ninety_daily)
    TextView mDaily;
    //较之前90天
    @BindView(R.id.tv_indent_ninety_before)
    TextView mCompare;
    //自定义刷新
    ...
    public static Fragment newInstance() {
        SubIndentNinetyFragment fragment = new SubIndentNinetyFragment();
        return fragment;
    }
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_indent_ninety;
    }
    ...
    public void incomeStatement() {
        ...
        try {
            ...
            jsonObject.put("startDay", "2019-03-12");
