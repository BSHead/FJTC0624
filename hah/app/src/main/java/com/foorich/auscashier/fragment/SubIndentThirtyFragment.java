 ...
 * version: 1.0
 */
public class SubIndentThirtyFragment extends BaseFragment {

    //筛选时间
    @BindView(R.id.tv_indent_thitry_time)
    TextView mTime;
    //30天订单
    @BindView(R.id.tv_indent_thitry_earning)
    TextView mEarning;
    //单日最高
    @BindView(R.id.tv_indent_thitry_biggest)
    TextView mBiggest;
    //日均
    @BindView(R.id.tv_indent_thitry_daily)
    TextView mDaily;
    //较之前30天
    @BindView(R.id.tv_indent_thitry_before)
    TextView mCompare;
    //自定义刷新
    ...
    public static Fragment newInstance() {
        SubIndentThirtyFragment fragment = new SubIndentThirtyFragment();
        return fragment;
    }
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_indent_thirty;
    }
    ...
    public void incomeStatement() {
        ...
        try {
            ...
            jsonObject.put("startDay", "2019-05-12");
            jsonObject.put("endDay", "2019-06-12");
            jsonObject.put("dateType", "30");
