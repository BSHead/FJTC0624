 ...
 * version: 1.0
 */
public class SubIncomeSevenFragment extends BaseFragment {


    //筛选时间
    @BindView(R.id.tv_income_seven_time)
    TextView mTime;
    //7天收入
    @BindView(R.id.tv_income_seven_earning)
    TextView mEarning;
    //单日最高
    @BindView(R.id.tv_income_seven_biggest)
    TextView mBiggest;
    //日均
    @BindView(R.id.tv_income_seven_daily)
    TextView mDaily;
    //较之前7天
    @BindView(R.id.tv_income_seven_before)
    TextView mCompare;
    //自定义刷新
    ...
    public static Fragment newInstance() {
        SubIncomeSevenFragment fragment = new SubIncomeSevenFragment();
        return fragment;
    }
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_income_seven;
    }
