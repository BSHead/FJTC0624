 ...
 * version: 1.0
 */
public class SubPaymenThirtyFragment extends BaseFragment {

    //筛选时间
    @BindView(R.id.tv_payment_thirty_time)
    TextView mTime;
    //报表
    @BindView(R.id.pv_payment_thirty)
    PieView mPieView;
    //自定义刷新
    @BindView(R.id.refresh)
    TwinklingRefreshLayout refreshLayout;
    //支付方式列表
    @BindView(R.id.re_payment_thirty)
    ...
    public static Fragment newInstance() {
        SubPaymenThirtyFragment fragment = new SubPaymenThirtyFragment();
        return fragment;
    }
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_payment_thirty;
    }
