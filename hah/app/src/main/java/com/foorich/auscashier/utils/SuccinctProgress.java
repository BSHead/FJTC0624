...
public class SuccinctProgress {
     /*  SuccinctProgress.showSuccinctProgress(MainActivity.this,
            "请求数据中···",SuccinctProgress.THEME_ULTIMATE,false,true);

            SuccinctProgress.showSuccinctProgress(MainActivity.this,
            "请求数据中···",SuccinctProgress.THEME_DOT,false,true);

            SuccinctProgress.showSuccinctProgress(MainActivity.this,
            "请求数据中···",SuccinctProgress.THEME_LINE,false,true);

            SuccinctProgress.showSuccinctProgress(MainActivity.this,
            "请求数据中···",SuccinctProgress.THEME_ARC,false,true);*/
